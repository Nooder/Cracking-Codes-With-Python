#!python3
# Chapter 19 Project - Frequency Analysis helper functions (module)

ETAOIN = 'ETAOINSHRDLCUMWFGYPBVKJXQZ'
LETTERS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'

def getLetterCount(message):
    # Returns a dictionary with keys as single letters and values of
...
def getFrequencyOrder(message):
    ...
    # frequetly occuring in the message parameter:
...
def englishFreqMatchScore(message):
    ...
    # and six least frequent letters are among the six most frequent
